function createUnityInstance(e, t, n) {
    ...
    function s(e, t, n) {
        for (var r in m) if (m[r].hasUnityMarker(e)) {
            ...
            return a.worker.callbacks[o] = n, void a.worker.postMessage({id: o, compressed: e}, [e.buffer])
        }
        n(e)
    }
    ...
    c.SystemInfo = function () {
        ...
        for (var t, n, r, a, i, o, s = navigator.userAgent + " ", l = [["Firefox", "Firefox"], ["OPR", "Opera"], ["Edg", "Edge"], ["SamsungBrowser", "Samsung Browser"], ["Trident", "Internet Explorer"], ["MSIE", "Internet Explorer"], ["Chrome", "Chrome"], ["CriOS", "Chrome on iOS Safari"], ["FxiOS", "Firefox on iOS Safari"], ["Safari", "Safari"]], d = 0; d < l.length; ++d) if (n = e(l[d][0] + "[/ ](.*?)[ \\)]", s, 1)) {
            t = l[d][1];
            break
        }
        "Safari" == t && (n = e("Version/(.*?) ", s, 1)), "Internet Explorer" == t && (n = e("rv:(.*?)\\)? ", s, 1) || n);
        for (var u = [["Windows (.*?)[;)]", "Windows"], ["Android ([0-9_.]+)", "Android"], ["iPhone OS ([0-9_.]+)", "iPhoneOS"], ["iPad.*? OS ([0-9_.]+)", "iPadOS"], ["FreeBSD( )", "FreeBSD"], ["OpenBSD( )", "OpenBSD"], ["Linux|X11()", "Linux"], ["Mac OS X ([0-9_.]+)", "macOS"], ["bot|google|baidu|bing|msn|teoma|slurp|yandex", "Search Bot"]], c = 0; c < u.length; ++c) if (a = e(u[c][0], s, 1)) {
            ...
            try {
                var a = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB,
                    i = setTimeout(function () {
                        "undefined" == typeof r.database && t(null)
                    }, 2e3), d = a.open(o.name);
        ...
        var o = {name: "UnityCache", version: 2}, s = {name: "XMLHttpRequest", version: 1},
        ...
        i.prototype.send = function (t) {
            var r = this.xhr, a = this.cache, i = arguments;
            return a.enabled = a.enabled && "arraybuffer" == r.responseType && !t, a.enabled ? void d.execute(s.name, "get", [a.result.url], function (t) {
                ...
                if (a.result = t, a.result.accessed = Date.now(), "immutable" == a.control) a.revalidated = !0, d.execute(s.name, "put", [a.result]), r.dispatchEvent(new Event("load")), e("'" + a.result.url + "' served from the indexedDB cache without revalidation"); else if (n(a.result.url) && (a.result.responseHeaders["Last-Modified"] || a.result.responseHeaders.ETag)) {
            ...
            require: function (e) {
                var t = {
                    "inflate.js": function (e, t, n) {
                        ...
                        var o = e("./zlib/inflate"), s = e("./utils/common"), l = e("./utils/strings"),
                            d = e("./zlib/constants"), u = e("./zlib/messages"), c = e("./zlib/zstream"),
                            f = e("./zlib/gzheader"), h = Object.prototype.toString;
                        r.prototype.push = function (e, t) {
                            var n, r, a, i, u, c, f = this.strm, p = this.options.chunkSize,
                                m = this.options.dictionary, b = !1;
                        ...
                        s[254] = s[254] = 1, n.string2buf = function (e) {
                            ...
                            var n, a, i, o, l = t || e.length, d = new Array(2 * l);
                            for (a = 0, n = 0; n < l;) if (i = e[n++], i < 128) d[a++] = i; else if (o = s[i], o > 4) d[a++] = 65533, n += o - 1; else {
                        ...
                        function u(e) {
                            if (ve) {
                                ...
                                for (x(S, e.lens, 0, 288, b, 0, e.work, {bits: 9}), t = 0; t < 32;) e.lens[t++] = 5;
                        ...
                        function f(e, t) {
                            var n, a, i, o, s, l, d, f, h, p, m, b, g, me, be, ge, we, ve, ye, ke, xe, _e, Se, Ee,
                                Le = 0, Be = new w.Buf8(4),
                            ...
                            e:for (; ;) switch (n.mode) {
                                case D:
                                    ...
                                    if (f >>>= 4, h -= 4, xe = (15 & f) + 8, 0 === n.wbits) n.wbits = xe; else if (xe > n.wbits) {
                                ...
                                case ee:
                                    ...
                                    if (n.lencode = n.lendyn, n.lenbits = 7, Se = {bits: n.lenbits}, _e = x(_, n.lens, 0, 19, n.lencode, 0, n.work, Se), n.lenbits = Se.bits, _e) {
                                ...
                                case te:
                                    for (; n.have < n.nlen + n.ndist;) {
                                        ...
                                        if (we < 16) f >>>= be, h -= be, n.lens[n.have++] = we; else {
                                            if (16 === we) {
                                                for (Ee = be + 2; h < Ee;) {
                                                    if (0 === l) break e;
                                                    l--, f += a[o++] << h, h += 8
                                    ...
                                    if (n.lenbits = 9, Se = {bits: n.lenbits}, _e = x(S, n.lens, 0, n.nlen, n.lencode, 0, n.work, Se), n.lenbits = Se.bits, _e) {
                                        e.msg = "invalid literal/lengths set", n.mode = fe;
                                        break
                                    }
                                    if (n.distbits = 6, n.distcode = n.distdyn, Se = {bits: n.distbits}, _e = x(E, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, Se), n.distbits = Se.bits, _e) {
                        ...
                        function m(e, t) {
                            ...
                            return e && e.state ? (n = e.state, 0 !== n.wrap && n.mode !== X ? A : n.mode === X && (r = 1, r = v(r, t, i, 0), r !== n.check) ? I : (a = c(e, t, i, i)) ? (n.mode = he, T) : (n.havedict = 1, R)) : A
                        }

                        var b, g, w = e("../utils/common"), v = e("./adler32"), y = e("./crc32"), k = e("./inffast"),
                            x = e("./inftrees"), _ = 0, S = 1, E = 2, L = 4, B = 5, C = 6, R = 0, O = 1, U = 2, A = -2,
                            I = -3, T = -4, N = -5, H = 8, D = 1, Z = 2, z = 3, F = 4, j = 5, M = 6, P = 7, W = 8,
                            q = 9, G = 10, X = 11, K = 12, V = 13, Y = 14, Q = 15, J = 16, $ = 17, ee = 18, te = 19,
                            ne = 20, re = 21, ae = 22, ie = 23, oe = 24, se = 25, le = 26, de = 27, ue = 28, ce = 29,
                            fe = 30, he = 31, pe = 32, me = 852, be = 592, ge = 15, we = ge, ve = !0;
                        ...
                        t.exports = function (e, t) {
                            ...
                            e:do {
                                ...
                                t:for (; ;) {
                                    if (x = k >>> 24, m >>>= x, b -= x, x = k >>> 16 & 255, 0 === x) C[s++] = 65535 & k; else {
                                        if (!(16 & x)) {
                                            if (0 === (64 & x)) {
                                                k = g[(65535 & k) + (m & (1 << x) - 1)];
                                                continue t
                        ...
                        "use strict";
                        var r = e("../utils/common"), a = 15, i = 852, o = 592, s = 0, l = 1, d = 2,
                        ...
                        t.exports = function (e, t, n, p, m, b, g, w) {
                            var v, y, k, x, _, S, E, L, B, C = w.bits, R = 0, O = 0, U = 0, A = 0, I = 0, T = 0, N = 0,
                                H = 0, D = 0, Z = 0, z = null, F = 0, j = new r.Buf16(a + 1), M = new r.Buf16(a + 1),
                                P = null, W = 0;
                            for (R = 0; R <= a; R++) j[R] = 0;
                            ...
                            for (U = 1; U < A && 0 === j[U]; U++) ;
                            for (I < U && (I = U), H = 1, R = 1; R <= a; R++) if (H <<= 1, H -= j[R], H < 0) return -1;
                            if (H > 0 && (e === s || 1 !== A)) return -1;
                            for (M[1] = 0, R = 1; R < a; R++) M[R + 1] = M[R] + j[R];
                            for (O = 0; O < p; O++) 0 !== t[n + O] && (g[M[t[n + O]]++] = O);
                            if (e === s ? (z = P = g, S = 19) : e === l ? (z = u, F -= 257, P = c, W -= 257, S = 256) : (z = f, P = h, S = -1), Z = 0, O = 0, R = U, _ = b, T = I, N = 0, k = -1, D = 1 << I, x = D - 1, e === l && D > i || e === d && D > o) return 1;
                            for (; ;) {
                                E = R - N, g[O] < S ? (L = 0, B = g[O]) : g[O] > S ? (L = P[W + g[O]], B = z[F + g[O]]) : (L = 96, B = 0), v = 1 << R - N, y = 1 << T, U = y;
                                do y -= v, m[_ + (Z >> N) + y] = E << 24 | L << 16 | B | 0; while (0 !== y);
                                for (v = 1 << R - 1; Z & v;) v >>= 1;
                                ...
                                if (R > I && (Z & x) !== k) {
                                    for (0 === N && (N = I), _ += U, T = R - N, H = 1 << T; T + N < A && (H -= j[T + N], !(H <= 0));) T++, H <<= 1;
                                    if (D += 1 << T, e === l && D > i || e === d && D > o) return 1;
                                    k = Z & x, m[k] = I << 24 | T << 16 | _ - b | 0
                                }
                            }
                            return 0 !== Z && (m[_ + Z] = R - N << 24 | 64 << 16 | 0), w.bits = I, 0
                        }
                    }
                };
